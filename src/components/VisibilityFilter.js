...
const VisibilityFilter = props => {
  ...
  return (
    <Form>
      ...
      <Form.Dropdown label='Office' name='office' value={props.visibilityFilter.offices} onChange={handleChange} fluid search multiple selection options={offices} />
      ...
      <Form.Input label='Projects' name='projects' value={props.visibilityFilter.projects} onChange={handleChange} />
      <Form.Button content='Reset Filters' />
    </Form>
  )
}
